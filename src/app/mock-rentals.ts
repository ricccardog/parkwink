...
export const RENTALS: Rentals[]= [
    {id: 1,
     car: {_id: '9', model:"sla", maker: "tesla" , creationDate: new Date (1982,3,2), price: 123} as Car,
    ...
    {id: 2,
     car: {_id:'27', model:"panino", maker: "kebab" , creationDate: new Date (2057, 1,3), price: 765} as Car,
